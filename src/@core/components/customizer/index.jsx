    ...
    !breakpointReached && (
      ...
      >
        <div className={styles.toggler} onClick={handleToggle}>
          ...
          <SettingsIcon className='tabler-settings text-[22px]' />
        </div>
        <div className={styles.header}>
          ...
          <div className='flex gap-4'>
            ...
            <XIcon className='cursor-pointer text-textPrimary tabler-x' onClick={handleToggle} />
          </div>
        </div>
        <ScrollWrapper
          {...(isBelowLgScreen
                ...
                <div className='flex items-center justify-between'>
                  ...
                  >
                    ...
                    >
                      ...
                      <PipetteIcon className='tabler-color-picker text-xl' />
                    </div>
                  </div>
                  <Popper
                    transition
                ...
                <div className='flex items-center justify-between'>
                  <div className='flex flex-col items-start gap-0.5'>
                    ...
                    >
                      ...
                      <SunIcon className='tabler-sun text-[30px]' />
                    </div>
                  ...
                  <div className='flex flex-col items-start gap-0.5'>
                    ...
                    >
                      ...
                      <MoonIcon className='tabler-moon-stars text-[30px]' />
                    </div>
                  ...
                  <div className='flex flex-col items-start gap-0.5'>
                    ...
                    >
                      ...
                      <LaptopIcon className='tabler-device-laptop text-[30px]' />
                    </div>
